            ...
            <div className="m-8 bg-white absolute py-8 pl-8 pr-8 overflow-hidden w-auto min-h-full">
                    ...
                    <div>
                        ...
                        <div className="text-center text-blue-500 p-20">
                            ...
                            <input type="file" name="photo" id="photo" accept=".jpg,.jpeg,.png" className="opacity-0 z-1 absolute" />
                            <br />
                            <br />
                            <hr />
                        </div>
                        <div className="grid grid-cols-2 gap-x-24 ">
                            <div className="bottom-left">
                                <label className='text-sm'>Nom Complet</label><br />
                                <input type="text" className="p-2 rounded-lg border border-gray-500 w-80 focus:outline-none" /><br /><br />
                            ...
                            <div className="border-dashed border border-yellow-300 rounded-lg inline-block px-20 py-10 text-center">
                                ...
                                <p className="text-sm text-blue-900">En format PDF,la taille du fichier doit être maximale de 10 Mo </p>
                                <br />
                   ...
                   <button type="submit" className="bg-blue-500 text-white rounded-lg border-none px-8 py-4 m-4">Envoyer ma demande</button>
                    <button type="reset" className="bg-white border border-red-300 rounded-lg px-8 py-4 m-4">Annuler</button>
                   </div>
