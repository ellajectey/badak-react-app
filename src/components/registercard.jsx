...
function Registercard() {
    ...
    <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <img className="mx-auto h-10 w-auto" src={img} alt="Workflow"/>
            ...
            <form method="POST" action="#">
                ...
                <div className="mt-6">
                    ...
                    iworkedon.com/
                        ...
                        <input id="username" name="username" placeholder="john" type="text" required="" value="" className="flex-1 form-input pl-3 block w-full rounded-none rounded-r-md transition duration-150 ease-in-out sm:text-sm sm:leading-5 "/>
                    </div>
                </div>
